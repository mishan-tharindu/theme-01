...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);;(function($){$('.fl-node-3iftc25lzhx9 .pp-breadcrumbs a').parent().css({'padding':'0','background-color':'transparent','border':'0','margin':'0','box-shadow':'none'});$('.fl-node-3iftc25lzhx9 .pp-breadcrumbs a').parent().parent().css({'padding':'0','background-color':'transparent','border':'0','margin':'0','box-shadow':'none'});})(jQuery);;(function($){PPInfoList=function(settings){this.id=settings.id;this.layout=settings.layout;this.breakpoints=settings.breakpoints;this.node=$('.fl-node-'+this.id);this.wrap=this.node.find('.pp-infolist');this.connector=this.node.find('.pp-list-connector');this._init();$(window).on('resize',$.proxy(this._init,this));};PPInfoList.prototype={_init:function(){var layout=this._getLayout();this.wrap.removeClass('layout-1 layout-2 layout-3');this.wrap.addClass('layout-'+layout);if(1==layout){this.connector.css('left',(this.node.find('.pp-icon-wrapper').width()/2)+'px');}
...
return breakpoints;},};})(jQuery);(function($){new PPInfoList({id:'mr94geix8nhf',layout:{large:'1',medium:'',responsive:'',},breakpoints:{medium:'992',responsive:'768',},});})(jQuery);(function($){new PPInfoList({id:'ce68dquat3js',layout:{large:'1',medium:'',responsive:'',},breakpoints:{medium:'992',responsive:'768',},});})(jQuery);(function($){new PPInfoList({id:'7kuhcyvp1gs3',layout:{large:'1',medium:'',responsive:'',},breakpoints:{medium:'992',responsive:'768',},});})(jQuery);(function($){window.onLoadPPReCaptcha=function(){var reCaptchaFields=$('.pp-grecaptcha'),widgetID;if(reCaptchaFields.length>0){reCaptchaFields.each(function(i){var self=$(this),attrWidget=self.attr('data-widgetid'),newID=$(this).attr('id')+'-'+i;if((typeof attrWidget!==typeof undefined&&attrWidget!==false)){return;}
...
$(document).trigger('pp_contact_form_after_submit',[$(this.nodeClass),response]);}};})(jQuery);(function($){$(function(){new PPContactForm({id:'9qcy5m1xtkub'});});})(jQuery);jQuery(function($){$(function(){$('.fl-node-qrx5i2p1zj4c .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});jQuery(function($){$(function(){$('.fl-node-st472q9einb5 .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});(function($){$(function(){$('.fl-map').on('click',function(){$(this).find('iframe').css('pointer-events','auto');});});})(jQuery);