...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);;(function($){$('.fl-node-au42rpeh51sx .pp-breadcrumbs a').parent().css({'padding':'0','background-color':'transparent','border':'0','margin':'0','box-shadow':'none'});$('.fl-node-au42rpeh51sx .pp-breadcrumbs a').parent().parent().css({'padding':'0','background-color':'transparent','border':'0','margin':'0','box-shadow':'none'});})(jQuery);(function($){FLBuilderPostGrid=function(settings)
...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'1gr9ih5q8v0n',layout:'columns',pagination:'numbers',postSpacing:'60',postWidth:'300',matchHeight:{default:'1',medium:'',responsive:''},isRTL:false});});})(jQuery);